...
plot(x=pca.metadata$PC1, y=pca.metadata$PC2, xlab="PC1 (3.18%)", ylab="PC2 (1.23%)", xlim=c(-1.0,1.0),ylim=c(-0.55,0.55), pch=pch.group, col="black", bg=col.group, cex=2, las=1, asp=1)
