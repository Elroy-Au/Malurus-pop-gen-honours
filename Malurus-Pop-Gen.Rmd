...
# temperate only
# there is an error here - it doesn't like this covariance matrix for some reason
inbreed.model <- mmer(fixed = INBREEDING ~ ScaledChangeMeanTemp * ScaledNdays35five + ScaledChangeMeanTemp * ScaledNdays5five + ScaledRainfive * ScaledChangeRain, random = ~ vs(ID, Gu=T.G) + Year + IBRA, rcov= ~ units, data=nmd.temp.clim.var) 
```
...
# tropical + temperate 
adonis2(G ~ ScaledChangeMeanTemp*ScaledNdays35five + ScaledChangeMeanTemp*ScaledNdays5five + ScaledRainfive*ScaledChangeRain + Year + IBRA, data = nmd.clim.var)
